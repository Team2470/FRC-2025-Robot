...
public class DriveStraightBackFast extends SequentialCommandGroup {
    ...
    public DriveStraightBackFast(CommandSwerveDrivetrain drivetrain, double distanceMeters) {
        addCommands(
