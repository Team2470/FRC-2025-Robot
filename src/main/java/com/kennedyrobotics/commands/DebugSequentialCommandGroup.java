...
public class DebugSequentialCommandGroup extends Command {
  ...
  public DebugSequentialCommandGroup(Command... commands) {
    ...
    SmartDashboard.putNumber(getName() + " current index", m_currentCommandIndex);
    SmartDashboard.putString(getName() + " current name", "null");
    SmartDashboard.putBoolean(getName() + " running", false);
  }
  ...
  public final void initialize() {
    SmartDashboard.putBoolean(getName() + " running", true);
  ...
  public final void execute() {
    ...
    if (getName() != null) {
      SmartDashboard.putNumber(getName() + " current index", m_currentCommandIndex);
      SmartDashboard.putString(getName() + " current name", currentCommand.getName());  
    }
